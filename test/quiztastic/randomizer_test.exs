defmodule Quiztastic.RandomizerTest do
  use ExUnit.Case

  alias Quiztastic.Randomizer
  ...
  test "generate random string of different length" do
    random = Randomizer.randomizer(2)
    assert 2 = String.length(random)
    assert String.match?(random, ~r/[A-Za-z0-9]/)
  end
